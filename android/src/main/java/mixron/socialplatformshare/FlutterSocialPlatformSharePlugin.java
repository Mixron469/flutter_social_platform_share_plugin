package mixron.socialplatformshare;
...
/**
 * FlutterSocialPlatformSharePlugin
 */
public class FlutterSocialPlatformSharePlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    final private static String _methodFaceBookUrl = "facebook_share_url";
    ...
    public static void registerWith(Registrar registrar) {
        final FlutterSocialPlatformSharePlugin instance = new FlutterSocialPlatformSharePlugin();
    ...
    private void onAttachedToEngine(BinaryMessenger messenger) {
        methodChannel = new MethodChannel(messenger, "flutter_social_platform_share_plugin");
    ...
    public void onMethodCall(MethodCall call, @NonNull Result result) {
        ...
        switch (call.method) {
            case _methodFaceBook:
                ...
                break;
            case _methodFaceBookUrl:
                url = call.argument("url");
                msg = call.argument("msg");
                shareUrlToFacebook(url, msg, result);
                break;
     ...
     * @param result Result
     */
    private void shareUrlToFacebook(String url, String msg, Result result) {
